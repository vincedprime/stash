...
The landing page is plain HTML, CSS, and JavaScript in [`docs/`](docs/index.html). See the [image capture notes](docs/assets/README.md) before updating its images. The release workflow builds a DMG on every push to `main`; documentation-only filtering is still pending.
